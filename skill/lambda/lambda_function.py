...
def launch_request_handler(handler_input: HandlerInput):
    ...
    if not endpoints:
        ...
        return (response_builder
                .speak("I couldn't find your gadget. Please try again after connecting your gadget.")
    ...
    # Send the BlinkLEDDirective to make the LED green for 20 seconds.
    return (response_builder
            ...
            .add_directive(build_blink_led_directive(endpoint_id, ['ALEXA BLUE'], 1000, 20, False))
...
def yes_intent_handler(handler_input: HandlerInput):
    ...
    # Send the BlinkLED Directive to trigger the cycling animation of the LED.
    # and, start a EventHandler for 10 seconds to receive only one
    return (response_builder
            .add_directive(build_blink_led_directive(endpoint_id,
                                                     ['RED', 'YELLOW', 'WHOLE FOODS GREEN', 'CYAN',
                                                      'TWITCH PURPLE', 'AMAZON ORANGE', 'ALEXA BLUE'],
                                                     1000, 20, True))
